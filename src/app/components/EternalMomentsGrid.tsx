...
export function EternalMomentsGrid() {
  return (
    <section className="relative isolate overflow-hidden py-16 lg:py-24 bg-white">
      ...
      <div className="w-full px-4 lg:px-8">
        <div className="max-w-none">
          <div className="grid grid-cols-12 gap-4 lg:gap-6 max-h-[500px] lg:max-h-[600px] xl:max-h-[700px]">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <div className="text-center transform group-hover:scale-105 transition-transform duration-300">
                      <div className="bg-white/95 backdrop-blur-sm px-6 py-4 lg:px-8 lg:py-6 shadow-lg border border-white/20">
                        <h4 className="text-lg lg:text-xl xl:text-2xl font-light text-gray-900 tracking-wide mb-2">
                          TRADITIONAL
                        </h4>
              ...
              <div className="relative group h-full overflow-hidden">
                ...
                <div className="absolute top-6 right-6 z-20">
                  <div className="bg-white/90 backdrop-blur-sm px-4 py-2 shadow-sm border border-white/20">
                    <span className="text-xs font-medium text-gray-900 tracking-wider uppercase">
                      HOT
                    </span>
                  </div>
                </div>
